...
export const ENVIRONMENT = {
  ...
  // Firebase Configuration (Legacy - can be removed)
  FIREBASE: {
    apiKey: __DEV__ 
      ? "AIzaSyBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" // Development key
      : "AIzaSyBXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", // Production key (same for now)
    authDomain: __DEV__ 
