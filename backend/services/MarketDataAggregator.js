...
class MarketDataAggregatorService {
  ...
  aggregateMarketData(sources, query) {
    ...
    if (ebayApiData && ebayApiData.type === 'market_data') {
      primaryMarketValue = ebayApiData.data.marketValue;
      primaryPawnValue = ebayApiData.data.pawnValue;
      primaryConfidence = ebayApiData.data.confidence;
      primaryDataPoints = ebayApiData.data.dataPoints;
      primaryPriceRange = ebayApiData.data.priceRange;
      primarySource = 'ebay-api';
    } else if (ebayScraperData && ebayScraperData.type === 'market_data') {
      primaryMarketValue = ebayScraperData.data.marketValue;
      primaryPawnValue = ebayScraperData.data.pawnValue;
      primaryConfidence = ebayScraperData.data.confidence;
      primaryDataPoints = ebayScraperData.data.dataPoints;
      primaryPriceRange = ebayScraperData.data.priceRange;
    ...
    marketDataSources.forEach(sourceName => {
      ...
      if (sourceData?.data && sourceData.data.type === 'market_data') {
        possibleMarketRates.push({
          source: sourceName,
          marketValue: sourceData.data.data.marketValue,
          pawnValue: sourceData.data.data.pawnValue,
          confidence: sourceData.data.data.confidence,
          dataPoints: sourceData.data.data.dataPoints,
          priceRange: sourceData.data.data.priceRange,
